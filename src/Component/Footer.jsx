      ...
      <div className="container">
        ...
        <div className="row mb-5">
          ...
          <div className="col-lg-3 col-md-6">
            <div className="ftco-footer-widget mb-1 ml-md-5">
          ...
          <div className="col-lg-4 col-md-6">
            <div className="ftco-footer-widget mb-1">
            	...
            	<div className="block-23 mb-3">
	              <ul>
	                <li><span className="icon icon-map-marker"></span><span className="text">A-43, Ducate Noida, Secter 16 , Noida, UP, India</span></li>
	                <li><Link to ="#"><span className="icon icon-phone"></span><span className="text">+91 7061513533</span></Link></li>
	                <li><Link to ="#"><span className="icon icon-envelope"></span><span className="text">chhotanraaz@gmail.com</span></Link></li>
	              </ul>
	            </div>
            </div>
          </div>
